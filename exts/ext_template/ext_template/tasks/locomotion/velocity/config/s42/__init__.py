...
gym.register(
    id="Legged-Isaac-Attention-Rough-DreamWAQ-Kuavo-S42-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.attention_env_cfg:KuavoAttentionRoughEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:KuavoAttentionDreamWAQPPORunnerCfg",
    },
)
...
gym.register(
    ...
    kwargs={
        ...
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:KuavoAttentionRoughPPORunnerPlayCfg",
    },
)
...
gym.register(
    ...
    kwargs={
        ...
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_ame2_cfg:KuavoAttention2RoughPPORunnerCfg",
    },
)

gym.register(
    id="Legged-Isaac-LatentDistiilation-Rough-Kuavo-S42-Train-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.attention2_env_cfg:KuavoAttention2RoughEnvCfg",
